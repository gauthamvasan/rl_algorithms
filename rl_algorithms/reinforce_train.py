...
from rl_algorithms.agent.learner import Reinforce
from rl_algorithms.agent.mlp_policies import MLPGaussianActor
...
def main():
    ...
    learner = Reinforce(cfg=cfg, pi=pi, buffer=buffer, device=device)
    ####### End
    ...
    for steps in range(num_steps):
        ...
        learner.push_and_update(obs=o, action=a, reward=r, log_prob=lprob, done=done)
        o = op

...
from rl_algorithms.agent.utils import random_augment
...
if __name__ == '__main__':
    ...
    encoder = SSEncoderModel(image_shape=(3, 256, 256), proprioception_shape=(5,), net_params=config, rad_offset=0.01)
